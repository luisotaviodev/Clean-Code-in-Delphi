...
type
  TPresenterJson = class (TInterfacedObject, TPresenter)
...
function TPresenterJson.ConverterCliente(oCliente: TCliente): String;
var
  cCliente: String;
begin
...
function TPresenterJson.ConverterLista(oLista: TList<TObject>): String;
var
  cLista: String;
  oObject: TObject;
  i: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      if(oObject is TLocacao)then
      begin
        cLista := cLista + ConverterLocacao(TLocacao(oObject))+QL;
      end;
    end;
  end;
  Result := '['+cLista+']';
...
function TPresenterJson.ConverterLocacao(oLocacao: TLocacao): String;
var
  cLocacao: String;
begin
...
function TPresenterJson.ConverterResponse(oResponse: TResponse): String;
var
...
function TPresenterJson.ConverterVeiculo(oVeiculo: TVeiculo): String;
var
  cVeiculo: String;
begin
